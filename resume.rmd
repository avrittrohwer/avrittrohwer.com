...
- Systems and embedded programming in C.
...
**BS Computer Science** \hfill September 2016 - current
...
- Fault tolerant and self healing systems using an Elixir/Erlang stack.
- Functional programming paradigm.
- Extending vim into a sufficient development platform.
